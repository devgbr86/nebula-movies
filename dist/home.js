...
export function renderHome(app) {
    ...
    <div class="home-wrap">
      ...
      <div class="home-nav-section">
        ...
        <div class="home-nav-grid">
          ...
          <button class="home-nav-btn" id="btn-top-fantasy">Top 10 Fantasy</button>
          ...
          <button class="home-nav-btn" id="btn-top-biography">Top 10 Biography</button>
          <button class="home-nav-btn" id="btn-top-animation">Top 10 Animation</button>
        </div>
      </div>
      ...
      <div class="home-nav-section">
        ...
        <div class="home-nav-grid">
          ...
          <button class="home-nav-btn" id="btn-latest-fantasy">Latest Fantasy</button>
          ...
          <button class="home-nav-btn" id="btn-latest-biography">Latest Biography</button>
          <button class="home-nav-btn" id="btn-latest-animation">Latest Animation</button>
        </div>
      </div>
  ...
  `;
    ...
    document.getElementById("btn-top-biography").addEventListener("click", () => navigate("/category/top/biography"));
    document.getElementById("btn-top-animation").addEventListener("click", () => navigate("/category/top/animation"));
    document.getElementById("btn-latest-scifi").addEventListener("click", () => navigate("/category/latest/scifi"));
    document.getElementById("btn-latest-fantasy").addEventListener("click", () => navigate("/category/latest/fantasy"));
    ...
    document.getElementById("btn-latest-biography").addEventListener("click", () => navigate("/category/latest/biography"));
    document.getElementById("btn-latest-animation").addEventListener("click", () => navigate("/category/latest/animation"));
}
