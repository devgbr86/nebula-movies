...
function setStatus(msg: string, isError: boolean): void {
  const el = document.getElementById("status-msg") as HTMLDivElement;
  el.textContent = msg;
...
// ─── Top 10 ───────────────────────────────────────────────
export async function loadTopScifi(): Promise<void> {
...
// ─── Latest ───────────────────────────────────────────────
export async function loadLatestScifi(): Promise<void> {
